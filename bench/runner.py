...
PROMPT_TEMPLATE = (
    ...
    "---\n"
    "\n"
    "Task: from the corpus above, extract the resolution steps for ticket "
    "`{ticket_id}` exactly as they appear under the `## Resolution steps` "
    "section of that ticket.\n"
    "\n"
    "Rules:\n"
    "- Output ONLY the numbered list of resolution steps, one step per line, "
    "in the original order.\n"
    "- Reproduce each step verbatim — do NOT paraphrase, do NOT shorten.\n"
    "- Do NOT include the section heading, do NOT add commentary, "
    "do NOT add markdown code fences.\n"
    "- If the ticket does not exist or the section cannot be found, output "
    "the literal string `NOT_FOUND` and nothing else.\n"
    "{thinking_suffix}"
)
